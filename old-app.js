...
export default class App extends Component {
        ...
        BleManager.connect(peripheral.id).then(() => {
          ...
          setTimeout(() => {
            ...
            BleManager.retrieveServices(peripheral.id).then((peripheralInfo) => {
              ...
              var service = 'adaf0100-4369-7263-7569-74507974686e';
              var bakeCharacteristic = 'adaf0201-4369-7263-7569-74507974686e';
              var filenameCharacteristic = 'adaf0200-4369-7263-7569-74507974686e';
  ...
  render() {
    ...
    //     </TouchableHighlight>
    //     <FlatList
    //       ListEmptyComponent={<View style={{flex:1, margin: 20}}>
    ...
    //               <Text style={{fontSize: 8, textAlign: 'center', color: '#333333', padding: 10}}>id: {item.id}</Text>
    //             </View>
    //           </TouchableHighlight>
    //         );
    //       }}
